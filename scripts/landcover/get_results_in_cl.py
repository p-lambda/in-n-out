...
if __name__ == "__main__":
    ...
    #     cmd = f'cl run -n landcover_{exp_name} -w in-n-out-iclr-landcover --request-docker-image ananya/in-n-out --request-queue tag=nlp {deps} :get_pastable.py "python get_pastable.py -a {dirnames}"'
    ...
    for it in [0, 1]:
        ...
        cmd = f'cl run -n landcover_{exp_name}_iter{it} -w in-n-out-iclr-landcover --request-docker-image ananya/in-n-out --request-queue tag=nlp {deps} :get_pastable.py "python get_pastable.py -a {dirnames}"'
